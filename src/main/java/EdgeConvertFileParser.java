...
public abstract class EdgeConvertFileParser {
		...
		protected int numFigure, numConnector, numFields, numTables;
		...
		protected void parseFile() throws IOException {
				while ((currentLine = br.readLine()) != null) {
						...
						if (currentLine.startsWith("Connector ")) { // this is the start of a Connector entry
								...
								endStyle1 = currentLine.substring(currentLine.indexOf("\"") + 1, currentLine.lastIndexOf("\"")); // get the End1
								// parameter
								currentLine = br.readLine().trim(); // End2
								endStyle2 = currentLine.substring(currentLine.indexOf("\"") + 1, currentLine.lastIndexOf("\"")); // get the End2
								// parameter
